...
class SearchSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        # chrome_options.binary_location = r'F:\qfproject\ScrapyProjects\baidu\baidu\spiders\chromedriver.exe'

        # self.brower = webdriver.Chrome(executable_path=r'F:\qfproject\ScrapyProjects\baidu\baidu\spiders\chromedriver.exe',
    ...
    def parse(self, response):
        ...
        for link in links:
            yield scrapy.Request(link.get_attribute('href'), callback=self.parse_target)  # 给对列
            yield {'title': link.text,  # 给管道
